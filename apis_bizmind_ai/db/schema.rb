...
ActiveRecord::Schema[7.1].define(version: 2025_12_20_120000) do
  ...
  create_table "user_preferences", force: :cascade do |t|
    ...
    t.string "default_output_format", default: "pdf"
  ...
  create_table "user_profiles", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["full_name"], name: "index_user_profiles_on_full_name"
    t.index ["skills"], name: "index_user_profiles_on_skills", using: :gin
